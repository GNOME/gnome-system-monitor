                         ...
                         GParamSpec *pspec)
{
  ...
  switch (pid)
    ...
    case PROP_TYPE:
      ...
      break;
    case PROP_TOTAL:
      g_value_set_string (value, self->total);
      break;
    case PROP_FREE:
      g_value_set_string (value, self->free);
      break;
    case PROP_AVAILABLE:
      g_value_set_string (value, self->available);
      break;
    case PROP_USED:
      g_value_set_string (value, self->used);
      break;
                         ...
                         GParamSpec   *pspec)
{
  ...
  switch (pid)
    ...
    case PROP_TYPE:
      ...
      break;
    case PROP_TOTAL:
      self->total = g_value_dup_string (value);
      break;
    case PROP_FREE:
      self->free = g_value_dup_string (value);
      break;
    case PROP_AVAILABLE:
      self->available = g_value_dup_string (value);
      break;
    case PROP_USED:
      self->used = g_value_dup_string (value);
      break;
    case PROP_PERCENTAGE:
